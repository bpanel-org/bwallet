...
import { selectWalletInfo, selectWallets, selectMultisigWalletInfo, selectMultisigWallets } from './selectors';
import {
  getWalletInfo,
  addSideNav,
  getWallets,
...
function mapStateToProps(state, otherProps) {
  ...
  const walletsNavMeta = [...sideMeta(walletInfo, 'standard'), ...sideMeta(multisigInfo, 'multisig')];

      ...
      <div>
        ...
        <BoxGrid colcount={1}>
          <BoxGrid colClass="d-flex align-items-start" colcount={1}>
            ...
            <Text type="p">Total balance: {selectedWalletBalance}</Text>
            <Text type="p">
              Total transactions: {selectedWalletTransactionCount}
            </Text>
            <Text type="p">Accounts: {accounts.length}</Text>
          </BoxGrid>
          <Header
            style={{ borderTop: theme.themeVariables.border2 }}
            type="h4"
          />
          <div className="p-2">
            <div className="row">

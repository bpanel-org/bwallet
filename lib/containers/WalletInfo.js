    ...
    return (
      <div>
        ...
        <BoxGrid colcount={1}>
          ...
          <Header style={{ borderBottom: theme.themeVariables.border2 }} type="h4">Account Info</Header>
          ...
          <BoxGrid colcount={4}>
            <div className="">
              ...
              <Text type="p">Transaction Count: {selectedAccountTransactionCount}</Text>
              <Text type="p">UTXO Count: {selectedAccountUTXOCount}</Text>
            </div>
            <div>
              <Text type="p">Average UTXO Size: {selectedAccountAvgUTXOSize}</Text>
              <Text type="p">Account Public Key (xpub): <Text type="condensed">{selectedAccountxpub}</Text></Text>
            </div>
            <div />
            <div />
          </BoxGrid>

        ...
        <div>
          ...
          {cosignerId && (
            <Label className="d-flex align-items-start" text="Cosigner ID">
              <Text style={style.secretText} type="p">{cosignerId}</Text>
            </Label>
          )}
          {joinKey && (
            <Label className="d-flex align-items-start" text="Join Key">
              <Text style={style.secretText} type="p">{joinKey}</Text>
            </Label>
          )}
          {token && (
            <Label className="d-flex align-items-start" text="Cosigner Token">
              <Text style={style.secretText} type="p">{token}</Text>
            </Label>
          )}
        </div>
        <BoxGrid colcount={1} rowClass="d-inline">
          <br/><br/> {/* pad the top a bit */}

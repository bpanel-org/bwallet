...
class CreateNew extends PureComponent {
  ...
  render() {
    const { createWallet, createHardwareWatchOnlyAccount } = this.props;
    ...
    if (renderNewWallet) render = <NewWallet createWallet={createWallet} />;
      ...
      render = <ImportWallet createHardwareWatchOnlyAccount={createHardwareWatchOnlyAccount} createWallet={createWallet} />;

...
class Overview extends PureComponent {
  ...
  render() {
    ...
    return (
      <div>
        <List text="Overview" headers={OVERVIEW_LIST_HEADERS} data={walletsList} />
        <List text="Pending Multiparty Wallets" headers={OVERVIEW_MP_LIST_HEADERS} data={pendingMultiparty} />

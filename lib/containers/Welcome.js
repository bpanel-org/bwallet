      ...
      <BoxGrid rowClass="text-center" colClass="align-self-center" colcount={2}>
        <div>
          ...
          <Text className="text-left" type="p">
            bwallet allows you to manage, use and build on top of you&#39;re own
            node. Blockchain was founded on the idea of giving people more
            control, but it turns out that control comes with a lot of
            responsibility.
          </Text>
          <Header type="h3">Features</Header>
          <Text className="text-left" type="p">
            View balances, send/receive transactions, create multisig wallets,
            use hardware devices, fork or submit new features
          </Text>
        </div>
        <div>
          <Text className="text-left" type="p">
            Remember that you are responsible for your funds. There is no way to
            call customer support to get them back. Understanding how to keep
            yourself safe in this new internet is very important.
          </Text>
          <Text type="p">Make sure that you are on the proper url - {uri}</Text>

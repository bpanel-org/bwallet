    ...
    return (
      <React.Fragment>
        ...
        >
          <div>
            ...
            <Text className="text-left" type="p">
              bwallet allows you to manage, use and build on top of your own
        ...
        <BoxGrid rowClass="text-center" colcount={2}>
          ...
          <div>
            <Header type="h3">bPanel and bWallet:</Header>
            <Header type="h5">Personal Sovereignty</Header>
            <Text className="text-left" type="p">
              You are responsible for your funds. There is no customer support,
              and there is no way to get money back if it is mishandled.
              Understanding how to keep yourself safe in this new internet is
              very important.
            </Text>
            <Header type="h5">This is not a bank.</Header>
            <Text type="p">
              This is a tool to help you run your own node, and manage your

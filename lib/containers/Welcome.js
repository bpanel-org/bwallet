    ...
    return (
      <React.Fragment>
        ...
        <BoxGrid rowClass="text-center" colcount={2}>
          ...
          <div>
            <Text className="text-left" type="p">
              Remember that you are responsible for your funds. There is no way
              to call customer support to get them back. Understanding how to
              keep yourself safe in this new internet is very important.
            </Text>
            <Text type="p">

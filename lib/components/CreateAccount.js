...
class CreateAccount extends PureComponent {
  ...
  renderStandard() {
    ...
    return (
      <BoxGrid rowClass="mb-2">
        ...
        <Label className="d-flex align-items-start" text="Select Address Type">
          <Dropdown
  ...
  async create() {
    ...
    if (!isWatchOnly) {
      ...
      let opts = { passphrase };
      if (addressType === 'Segwit') opts.witness = true;
      await createAccount(selectedWallet, accountId, opts, true);
    } else if (view === 'xpub') {

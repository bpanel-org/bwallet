...
import { Text, Button, QRCode, Header } from '@bpanel/bpanel-ui';
...
class ReceiveFunds extends PureComponent {
  ...
  render() {
    ...
    return (
      <BoxGrid rowClass="text-center" colClass="flex-column justify-content-center" colcount={2}>
        <BoxGrid rowClass="d-inline" colcount={1}>
          <Header type="h2">Receive Funds</Header>
          <Label text="Fresh Address:">
            <Text copyIcon={true} type="condensed">{receiveAddress}</Text>
          </Label>

...
// these options determine the userflow
// through the app when creating a new wallet
// define once in constant object
const opts = {
  walletTypeOpts: [
    {
...
class PreselectOptions extends PureComponent {
  constructor(props) {
    super(props);
    this.walletTypeOpts = opts.walletTypeOpts;
    this.keyManagementOpts = opts.keyManagementOpts;

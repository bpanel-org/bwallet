...
class SendFunds extends PureComponent {
  ...
  render() {
    const { selectedWallet, selectedAccount, unit, ticker } = this.props;
      ...
      >
        ...
        <BoxGrid rowClass="d-inline" colcount={1}>
          <Text className="m-auto">
            You are sending {this.convertCurrencyWithLabel(amount)} to {address || 'Add Recipient'} from {selectedAccount}{' '}
            in {selectedWallet}
          </Text>
        </BoxGrid>
      </BoxGrid>

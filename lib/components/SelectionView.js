  ...
  render() {
    return (
      <div
        ...
        style={{ borderStyle: 'solid', padding: '4rem' }}
        onClick={this.props.onClick}
      >
        <Header style={{textAlign: 'center'}} type="h1">{this.props.header}</Header>
        <Text style={{textAlign: 'center'}} type="p">{this.props.text}</Text>
        <i style={{ fontSize: '4rem' }} className={`fa ${this.props.icon} m-auto`} />
      </div>
    );
  }
}
